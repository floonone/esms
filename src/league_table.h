...
public:
  ...
  //
  void add_new_team(string name, int played = 0, int won = 0, int drawn = 0, int lost = 0,
    int goals_for = 0, int goals_against = 0, int goal_difference = 0, int points = 0);
...
private:
  struct team_data {
    ...
    team_data(string name_, int played_ = 0, int won_ = 0, int drawn_ = 0, int lost_ = 0,
      int goals_for_ = 0, int goals_against_ = 0, int goal_difference_ = 0, int points_ = 0)
        : name(name_), played(played_), won(won_), drawn(drawn_), lost(lost_),
          goals_for(goals_for_), goals_against(goals_against_), goal_difference(goal_difference_),
          points(points_) {
    }
