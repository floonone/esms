...
//
struct player_stat {
  player_stat(string name_, string team_name_, int games_, int goals_, int assists_, int dp_,
    int perf_points_)
      : name(name_), team_name(team_name_), games(games_), goals(goals_), assists(assists_),
        dp(dp_), perf_points(perf_points_) {
  }
